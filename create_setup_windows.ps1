...
.PARAMETER PythonVersion
    The version of Python to use for the virtual environment, e.g. "3.11.3".
...
.EXAMPLE
    Create a new virtual environment with Python 3.11.3 and install required packages:
    .\create_setup_windows.ps1 -PythonVersion "3.11.3" -EnvName "venv" -RequirementsFile ".\requirements.txt"
